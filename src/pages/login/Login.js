...
import React, { Fragment,useLayoutEffect,useContext, useState, useEffect } from "react";
...
//  console.log(navData.token,'login nav token............')
  ...
  const { values, errors, touched, handleBlur, handleChange, handleSubmit } =
    useFormik({
      ...
      onSubmit: (values, action) => {
        ...
        loginApi(values,authCtx,login,navigate,notify,Swal,dispatch,tableActions,allUsersApi)
                ...
                <Box sx={formBox}>
                  <form onSubmit={handleSubmit}>
                    ...
                    >
                      ...
                      <Typography onClick={() => navigate('/forgot')} sx={forgotBox}>Forgot password?</Typography>
                    </Stack>
